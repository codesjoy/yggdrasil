...
func (s *LibraryServer) CreateUser(ctx context.Context, req *errorhandlingpb.CreateUserRequest) (*errorhandlingpb.CreateUserResponse, error) {
...
func (s *LibraryServer) GetUser(ctx context.Context, req *errorhandlingpb.GetUserRequest) (*errorhandlingpb.GetUserResponse, error) {
...
func (s *LibraryServer) AuthenticateUser(ctx context.Context, req *errorhandlingpb.AuthenticateUserRequest) (*errorhandlingpb.AuthenticateUserResponse, error) {
...
func (s *LibraryServer) CreateBook(ctx context.Context, req *errorhandlingpb.CreateBookRequest) (*errorhandlingpb.CreateBookResponse, error) {
...
func (s *LibraryServer) GetBook(ctx context.Context, req *errorhandlingpb.GetBookRequest) (*errorhandlingpb.GetBookResponse, error) {
...
func (s *LibraryServer) BorrowBook(ctx context.Context, req *errorhandlingpb.BorrowBookRequest) (*errorhandlingpb.BorrowBookResponse, error) {
...
func (s *LibraryServer) ReturnBook(ctx context.Context, req *errorhandlingpb.ReturnBookRequest) (*errorhandlingpb.ReturnBookResponse, error) {
...
func (s *LibraryServer) CreateShelf(ctx context.Context, req *errorhandlingpb.CreateShelfRequest) (*errorhandlingpb.CreateShelfResponse, error) {
...
func (s *LibraryServer) AddBookToShelf(ctx context.Context, req *errorhandlingpb.AddBookToShelfRequest) (*errorhandlingpb.AddBookToShelfResponse, error) {
...
func (s *LibraryServer) TriggerError(ctx context.Context, req *errorhandlingpb.TriggerErrorRequest) (*errorhandlingpb.TriggerErrorResponse, error) {
