...
func testBorrowBookAlreadyBorrowed(ctx context.Context, client errorhandlingpb.LibraryServiceClient) {
	...
	// Borrow the book
	client.BorrowBook(ctx, &errorhandlingpb.BorrowBookRequest{
...
func testAddBookToShelfFull(ctx context.Context, client errorhandlingpb.LibraryServiceClient) {
	...
	client.AddBookToShelf(ctx, &errorhandlingpb.AddBookToShelfRequest{
