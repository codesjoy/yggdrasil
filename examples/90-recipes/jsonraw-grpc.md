...
这是一个 transport-level recipe，不是 examples 主线里的 bootstrap 推荐路径。要先把当前框架模型看清楚，优先读 [02-runtime-bundle](/Users/zhangwei/go/src/github.com/codesjoy/yggdrasil/examples/02-runtime-bundle)；如果你在看自定义 provider 接入，再对照 [20-capability-registration](/Users/zhangwei/go/src/github.com/codesjoy/yggdrasil/examples/20-capability-registration)。
