...
- 业务组合：[business/compose.go](business/compose.go)
- reload smoke test：[smoke_test.go](smoke_test.go)

## 下一步看什么

- 如果你要看更聚焦的 REST 行为，读 [10-rest-gateway](../10-rest-gateway/README_zh_CN.md)。
- 如果你要看 capability provider-only 扩展，读 [20-capability-registration](../20-capability-registration/README_zh_CN.md)。
