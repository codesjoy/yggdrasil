...
- bundle 组合：[business/compose.go](business/compose.go)
- bundle 测试：[business/compose_test.go](business/compose_test.go)

## 下一步看什么

- 如果你想看 watchable config、reload 和 spec diff 怎么联动，看 [03-diagnostics-reload](../03-diagnostics-reload/README_zh_CN.md)。
- 如果你想看 REST 专项，而不是 bundle 总览，看 [10-rest-gateway](../10-rest-gateway/README_zh_CN.md)。
