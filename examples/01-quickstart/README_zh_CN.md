...
- 业务组合：[server/business/compose.go](server/business/compose.go)
- 客户端入口：[client/main.go](client/main.go)

## 下一步看什么

- 如果你想先理解 `BusinessBundle` 能安装哪些东西，看 [02-runtime-bundle](../02-runtime-bundle/README_zh_CN.md)。
- 如果你想看配置 watch、reload 和 diagnostics 的联动，看 [03-diagnostics-reload](../03-diagnostics-reload/README_zh_CN.md)。
