...
func (s) TestInfof(t *testing.T) {
	TLogger.Infof("%v %v.", "Info", "message")
}

func (s) TestWarning(t *testing.T) {
	TLogger.Warningf("Warning", "message.")
}

func (s) TestWarningf(t *testing.T) {
	TLogger.Warningf("%v %v.", "Warning", "message")
}
...
func (s) TestError(t *testing.T) {
	...
	TLogger.Error("Expected", "reason")
	TLogger.Errorln("Expected ln", "reason")
	TLogger.Errorf("%v %v %v", "Expected", "formatted", "reason")
	for i := 0; i < numErrors; i++ {
		TLogger.Error("Expected repeated reason")
	}
}
