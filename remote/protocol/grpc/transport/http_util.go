...
const (
	...
	// baseContentType is the roundrobin content-type for gRPC.  This is a valid
...
var (
	...
	http2ErrConvTab = map[http2.ErrCode]code.Code{
		http2.ErrCodeNo:                 code.Code_INTERNAL,
		http2.ErrCodeProtocol:           code.Code_INTERNAL,
		http2.ErrCodeInternal:           code.Code_INTERNAL,
		http2.ErrCodeFlowControl:        code.Code_RESOURCE_EXHAUSTED,
		...
		http2.ErrCodeHTTP11Required:     code.Code_INTERNAL,
	}
	// HTTPStatusConvTab is the HTTP errors code to gRPC reason code conversion table.
	HTTPStatusConvTab = map[int]code.Code{
		// 400 Bad Request - INTERNAL.
		http.StatusBadRequest: code.Code_INTERNAL,
		// 401 Unauthorized  - UNAUTHENTICATED.
		http.StatusUnauthorized: code.Code_UNAVAILABLE,
		// 403 Forbidden - PERMISSION_DENIED.
		http.StatusForbidden: code.Code_PERMISSION_DENIED,
		// 404 Not Found - UNIMPLEMENTED.
		http.StatusNotFound: code.Code_UNIMPLEMENTED,
		// 429 Too Many Requests - UNAVAILABLE.
		http.StatusTooManyRequests: code.Code_UNAVAILABLE,
		// 502 Bad Gateway - UNAVAILABLE.
		http.StatusBadGateway: code.Code_UNAVAILABLE,
		// 503 Service Unavailable - UNAVAILABLE.
		http.StatusServiceUnavailable: code.Code_UNAVAILABLE,
		// 504 Gateway timeout - UNAVAILABLE.
		http.StatusGatewayTimeout: code.Code_UNAVAILABLE,
	}
)
...
// encodeGrpcMessage is used to encode errors code in header field
