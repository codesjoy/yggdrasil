...
func buildTransportCredentials(protoName string, serviceName string, client bool) (gcredentials.TransportCredentials, error) {
	return buildTransportCredentialsWithBuilders(nil, protoName, serviceName, client)
}

func buildTransportCredentialsWithBuilders(
	builders map[string]ycredentials.Builder,
	protoName string,
	serviceName string,
	client bool,
