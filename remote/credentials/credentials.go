...
// Builder is the interface for credentials builder
...
// GetBuilder returns the builder for the given name
...
// RegisterBuilder registers a builder for the given name
