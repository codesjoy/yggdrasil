...
func (externalServerRuntime) RESTMiddlewareProviders() map[string]rest.Provider {
	return map[string]rest.Provider{}
}

func (externalServerRuntime) MarshalerBuilders() map[string]marshaler.MarshalerBuilder {
	return map[string]marshaler.MarshalerBuilder{}
}

func (externalServerRuntime) BuildUnaryServerInterceptor(
	[]string,
) interceptor.UnaryServerInterceptor {
	return nil
}

func (externalServerRuntime) BuildStreamServerInterceptor(
	[]string,
