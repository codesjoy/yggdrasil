...
func (c *testCloseErrorClient) NewStream(
	context.Context,
	*stream.Desc,
	string,
...
func (c *testCloseErrorClient) Protocol() string    { return "mock" }
...
func TestClientUpdateStateBufferReplacement(t *testing.T) {
	...
	s1 := resolver.BaseState{
		Endpoints: []resolver.Endpoint{newMockEndpoint("old", "127.0.0.1:1001", "test")},
	}
	s2 := resolver.BaseState{
		Endpoints: []resolver.Endpoint{newMockEndpoint("new", "127.0.0.1:1002", "test")},
	}
