...
// MarshalerBuilder builds a marshaler for a given request.
type MarshalerBuilder func() (Marshaler, error) //nolint:revive // stutter is acceptable for clarity

// Registry defines a registry for marshaler.
