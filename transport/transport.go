...
// Package transport provides transport abstractions for yggdrasil.
package transport
...
type TransportClientProvider interface { //nolint:revive // stutter is acceptable for clarity
	Protocol() string
	NewClient(
		context.Context,
		string,
...
type TransportServerProvider interface { //nolint:revive // stutter is acceptable for clarity
	Protocol() string
