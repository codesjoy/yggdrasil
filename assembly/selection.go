...
const (
	...
	capLoggerHandler = "logger.handler"
	capLoggerWriter  = "logger.writer"
	capTracer        = "otel.tracer_provider"
	capMeter         = "otel.meter_provider"
	capStatsHandler  = "stats.handler"
	...
	capUnaryServer   = "interceptor.unary_server"
	capStreamServer  = "interceptor.stream_server"
	capUnaryClient   = "interceptor.unary_client"
	capStreamClient  = "interceptor.stream_client"
	capRESTMW        = "rest.middleware"
	capRegistry      = "registry.provider"
	capResolver      = "resolver.provider"
