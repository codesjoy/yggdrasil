...
func (externalClientRuntime) NewBalancer(string, string, balancer.Client) (balancer.Balancer, error) {
	return externalBalancer{}, nil
}

func (externalClientRuntime) BuildUnaryClientInterceptor(string, []string) interceptor.UnaryClientInterceptor {
	return nil
}

func (externalClientRuntime) BuildStreamClientInterceptor(string, []string) interceptor.StreamClientInterceptor {
	return nil
}

type externalRemoteClient struct{}

func (externalRemoteClient) NewStream(context.Context, *stream.Desc, string) (stream.ClientStream, error) {
	return nil, nil
}
func (externalRemoteClient) Close() error        { return nil }
func (externalRemoteClient) Scheme() string      { return "test://svc" }
